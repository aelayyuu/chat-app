...
class FirebaseNetwork extends StatefulWidget {
  const FirebaseNetwork({Key? key}) : super(key: key);

  @override
  _FirebaseNetworkState createState() =>
      _FirebaseNetworkState();
}

class _FirebaseNetworkState extends State<FirebaseNetwork> {
